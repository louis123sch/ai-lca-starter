...
from data_models import DocumentUnderstanding, InventoryExtraction, InventoryItemsResult
...
def understand_document(text: str, *, model: str | None = None, api_key: str | None = None, extra_instructions: str = "", source_document: str | None = None) -> DocumentUnderstanding:
    ...
    completion = _client(api_key).beta.chat.completions.parse(
        model=chosen_model,
        messages=[{"role": "system", "content": UNDERSTANDING_PROMPT}, {"role": "user", "content": user_prompt}],
...
def extract_inventory_from_text(text: str, *, model: str | None = None, api_key: str | None = None, extra_instructions: str = "", source_document: str | None = None) -> InventoryExtraction:
    ...
    completion = _client(api_key).beta.chat.completions.parse(
        model=chosen_model,
        messages=[{"role": "system", "content": EXTRACTION_PROMPT}, {"role": "user", "content": user_prompt}],
